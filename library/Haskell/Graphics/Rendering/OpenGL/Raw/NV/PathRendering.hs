...
extensionEntry "glPathCommandsNV" [t| GLuint -> GLsizei -> Ptr GLubyte -> GLsizei -> GLenum -> Ptr GLubyte -> IO () |]
extensionEntry "glPathCoordsNV" [t| GLuint -> GLsizei -> GLenum -> Ptr GLubyte -> IO () |]
extensionEntry "glPathSubCommandsNV" [t| GLuint -> GLsizei -> GLsizei -> GLsizei -> Ptr GLubyte -> GLsizei -> GLenum -> Ptr GLubyte -> IO () |]
extensionEntry "glPathSubCoordsNV" [t| GLuint -> GLsizei -> GLsizei -> GLenum -> Ptr GLubyte -> IO () |]
extensionEntry "glPathStringNV" [t| GLuint -> GLenum -> GLsizei -> Ptr GLubyte -> IO () |]
extensionEntry "glPathGlyphsNV" [t| GLuint -> GLenum -> Ptr GLubyte -> GLbitfield -> GLsizei -> GLenum -> Ptr GLubyte -> GLenum -> GLuint -> GLfloat -> IO () |]
extensionEntry "glPathGlyphRangeNV" [t| GLuint -> GLenum -> Ptr GLubyte -> GLbitfield -> GLuint -> GLsizei -> GLenum -> GLuint -> GLfloat -> IO () |]
extensionEntry "glWeightPathsNV" [t| GLuint -> GLsizei -> Ptr GLubyte -> Ptr GLfloat -> IO () |]
extensionEntry "glCopyPathNV" [t| GLuint -> GLuint -> IO () |]
extensionEntry "glInterpolatePathsNV" [t| GLuint -> GLuint -> GLuint -> GLfloat -> IO () |]
extensionEntry "glTransformPathNV" [t| GLuint -> GLuint -> GLenum -> Ptr GLfloat -> IO () |]
extensionEntry "glPathParameterivNV" [t| GLuint -> GLenum -> Ptr GLint -> IO () |]
extensionEntry "glPathParameteriNV" [t| GLuint -> GLenum -> GLint -> IO () |]
extensionEntry "glPathParameterfvNV" [t| GLuint -> GLenum -> Ptr GLfloat -> IO () |]
extensionEntry "glPathParameterfNV" [t| GLuint -> GLenum -> GLfloat -> IO () |]
extensionEntry "glPathDashArrayNV" [t| GLuint -> GLsizei -> Ptr GLfloat -> IO () |]
extensionEntry "glGenPathsNV" [t| GLsizei -> IO GLuint |]
extensionEntry "glDeletePathsNV" [t| GLuint -> GLsizei -> IO () |]
extensionEntry "glIsPathNV" [t| GLuint -> IO GLboolean |]
extensionEntry "glPathStencilFuncNV" [t| GLenum -> GLint -> GLuint -> IO () |]
extensionEntry "glPathStencilDepthOffsetNV" [t| GLfloat -> GLfloat -> IO () |]
extensionEntry "glStencilFillPathNV" [t| GLuint -> GLenum -> GLuint -> IO () |]
extensionEntry "glStencilStrokePathNV" [t| GLuint -> GLint -> GLuint -> IO () |]
extensionEntry "glStencilFillPathInstancedNV" [t| GLsizei -> GLenum -> Ptr GLubyte -> GLuint -> GLenum -> GLuint -> GLenum -> Ptr GLfloat -> IO () |]
extensionEntry "glStencilStrokePathInstancedNV" [t| GLsizei -> GLenum -> Ptr GLubyte -> GLuint -> GLint -> GLuint -> GLenum -> Ptr GLfloat -> IO () |]
extensionEntry "glPathCoverDepthFuncNV" [t| GLenum -> IO () |]
extensionEntry "glPathColorGenNV" [t| GLenum -> GLenum -> GLenum -> Ptr GLfloat -> IO () |]
extensionEntry "glPathTexGenNV" [t| GLenum -> GLenum -> GLint -> Ptr GLfloat -> IO () |]
extensionEntry "glPathFogGenNV" [t| GLenum -> IO () |]
extensionEntry "glCoverFillPathNV" [t| GLuint -> GLenum -> IO () |]
extensionEntry "glCoverStrokePathNV" [t| GLuint -> GLenum -> IO () |]
extensionEntry "glCoverFillPathInstancedNV" [t| GLsizei -> GLenum -> Ptr GLuint -> GLuint -> GLenum -> GLenum -> Ptr GLfloat -> IO () |]
extensionEntry "glCoverStrokePathInstancedNV" [t| GLsizei -> GLenum -> Ptr GLubyte -> GLuint -> GLenum -> GLenum -> Ptr GLfloat -> IO () |]
extensionEntry "glGetPathParameterivNV" [t| GLuint -> GLenum -> Ptr GLint -> IO () |]
extensionEntry "glGetPathParameterfvNV" [t| GLuint -> GLenum -> Ptr GLfloat -> IO () |]
extensionEntry "glGetPathCommandsNV" [t| GLuint -> Ptr GLubyte -> IO () |]
extensionEntry "glGetPathCoordsNV" [t| GLuint -> Ptr GLfloat -> IO () |]
extensionEntry "glGetPathDashArrayNV" [t| GLuint -> Ptr GLfloat -> IO () |]
extensionEntry "glGetPathMetricsNV" [t| GLbitfield -> GLsizei -> GLenum -> Ptr GLuint -> GLuint -> GLsizei -> Ptr GLfloat -> IO () |]
extensionEntry "glGetPathMetricRangeNV" [t| GLbitfield -> GLuint -> GLsizei -> GLsizei -> Ptr GLfloat -> IO () |]
extensionEntry "glGetPathSpacingNV" [t| GLenum -> GLsizei -> GLenum -> Ptr GLubyte -> GLuint -> GLfloat -> GLfloat -> GLenum -> Ptr GLfloat -> IO () |]
extensionEntry "glGetPathColorGenivNV" [t| GLenum -> GLenum -> Ptr GLint -> IO () |]
extensionEntry "glGetPathColorGenfvNV" [t| GLenum -> GLenum -> Ptr GLfloat -> IO () |]
extensionEntry "glGetPathTexGenivNV" [t| GLenum -> GLenum -> Ptr GLint -> IO () |]
extensionEntry "glGetPathTexGenfvNV" [t| GLenum -> GLenum -> Ptr GLfloat -> IO () |]
extensionEntry "glIsPointInFillPathNV" [t| GLuint -> GLuint -> GLfloat -> GLfloat -> IO GLboolean |]
extensionEntry "glIsPointInStrokePathNV" [t| GLuint -> GLfloat -> GLfloat -> IO GLboolean |]
extensionEntry "glGetPathLengthNV" [t| GLuint -> GLsizei -> GLsizei -> IO GLfloat |]
extensionEntry "glPointAlongPathNV" [t| GLuint -> GLsizei -> GLsizei -> GLfloat -> Ptr GLfloat -> Ptr GLfloat -> Ptr GLfloat -> Ptr GLfloat -> IO GLboolean |]
