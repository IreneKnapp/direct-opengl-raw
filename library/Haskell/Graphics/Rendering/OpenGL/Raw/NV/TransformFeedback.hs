...
extensionEntry "glTransformFeedbackAttribs" [t| GLsizei -> Ptr GLint -> GLenum -> IO () |]
extensionEntry "glTransformFeedbackVaryingsNV" [t| GLuint -> GLsizei -> Ptr GLint -> GLenum -> IO () |]
extensionEntry "glGetVaryingLocation" [t| GLuint -> Ptr GLchar -> IO GLint |]
extensionEntry "glGetActiveVarying" [t| GLuint -> GLuint -> GLsizei -> Ptr GLsizei -> Ptr GLsizei -> Ptr GLenum -> Ptr GLchar -> IO () |]
extensionEntry "glActiveVarying" [t| GLuint -> Ptr GLchar -> IO () |]
extensionEntry "glGetTransformFeedbackVaryingNV" [t| GLuint -> GLuint -> Ptr GLint -> IO () |]
