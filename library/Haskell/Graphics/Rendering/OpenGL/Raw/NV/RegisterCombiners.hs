...
extensionEntry "glCombinerParameterfv" [t| GLenum -> Ptr GLfloat -> IO () |]
extensionEntry "glCombinerParameteriv" [t| GLenum -> Ptr GLint -> IO () |]
extensionEntry "glCombinerParameterf" [t| GLenum -> GLfloat -> IO () |]
extensionEntry "glCombinerParameteri" [t| GLenum -> GLint -> IO () |]
extensionEntry "glCombinerInput" [t| GLenum -> GLenum -> GLenum -> GLenum -> GLenum -> GLenum -> IO () |]
extensionEntry "glCombinerOutput" [t| GLenum -> GLenum -> GLenum -> GLenum -> GLenum -> GLenum -> GLenum -> GLboolean -> GLboolean -> GLboolean -> IO () |]
extensionEntry "glFinalCombinerInput" [t| GLenum -> GLenum -> GLenum -> GLenum -> IO () |]
extensionEntry "glGetCombinerInputParameterfv" [t| GLenum -> GLenum -> GLenum -> GLenum -> Ptr GLfloat -> IO () |]
extensionEntry "glGetCombinerInputParameteriv" [t| GLenum -> GLenum -> GLenum -> GLenum -> Ptr GLint -> IO () |]
extensionEntry "glGetCombinerOutputParameterfv" [t| GLenum -> GLenum -> GLenum -> Ptr GLfloat -> IO () |]
extensionEntry "glGetCombinerOutputParameteriv" [t| GLenum -> GLenum -> GLenum -> Ptr GLint -> IO () |]
extensionEntry "glGetFinalCombinerInputParameterfv" [t| GLenum -> GLenum -> Ptr GLfloat -> IO () |]
extensionEntry "glGetFinalCombinerInputParameteriv" [t| GLenum -> GLenum -> Ptr GLint -> IO () |]
