...
extensionEntry "glReleaseShaderCompiler" [t| IO () |]
extensionEntry "glShaderBinary" [t| forall a . GLsizei -> Ptr GLuint -> GLenum -> Ptr a -> GLsizei -> IO () |]
extensionEntry "glGetShaderPrecisionFormat" [t| GLenum -> GLenum -> Ptr GLint -> Ptr GLint -> IO () |]
extensionEntry "glDepthRangef" [t| GLfloat -> GLfloat -> IO () |]
extensionEntry "glClearDepthf" [t| GLfloat -> IO () |]
