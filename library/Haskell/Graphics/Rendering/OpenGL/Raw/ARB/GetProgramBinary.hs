...
extensionEntry "glGetProgramBinary" [t| forall a . GLuint -> GLsizei -> Ptr GLsizei -> Ptr GLenum -> Ptr a -> IO () |]
extensionEntry "glProgramBinary" [t| forall a . GLuint -> GLenum -> Ptr a -> GLsizei -> IO () |]
