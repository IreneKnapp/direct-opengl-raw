...
extensionEntry "glProgramString" [t| forall a . GLenum -> GLenum -> GLsizei -> Ptr a -> IO () |]
extensionEntry "glBindProgram" [t| GLenum -> GLuint -> IO () |]
extensionEntry "glDeletePrograms" [t| GLsizei -> Ptr GLuint -> IO () |]
extensionEntry "glGenPrograms" [t| GLsizei -> Ptr GLuint -> IO () |]
extensionEntry "glProgramEnvParameter4d" [t| GLenum -> GLuint -> GLdouble -> GLdouble -> GLdouble -> GLdouble  -> IO () |]
extensionEntry "glProgramEnvParameter4dv" [t| GLenum -> GLuint -> Ptr GLdouble -> IO () |]
extensionEntry "glProgramEnvParameter4f" [t| GLenum -> GLuint -> GLfloat -> GLfloat -> GLfloat -> GLfloat  -> IO () |]
extensionEntry "glProgramEnvParameter4fv" [t| GLenum -> GLuint -> Ptr GLfloat -> IO () |]
extensionEntry "glProgramLocalParameter4d" [t| GLenum -> GLuint -> GLdouble -> GLdouble -> GLdouble -> GLdouble  -> IO () |]
extensionEntry "glProgramLocalParameter4dv" [t| GLenum -> GLuint -> Ptr GLdouble -> IO () |]
extensionEntry "glProgramLocalParameter4f" [t| GLenum -> GLuint -> GLfloat -> GLfloat -> GLfloat -> GLfloat  -> IO () |]
extensionEntry "glProgramLocalParameter4fv" [t| GLenum -> GLuint -> Ptr GLfloat -> IO () |]
extensionEntry "glGetProgramEnvParameterdv" [t| GLenum -> GLuint -> Ptr GLdouble -> IO () |]
extensionEntry "glGetProgramEnvParameterfv" [t| GLenum -> GLuint -> Ptr GLfloat -> IO () |]
extensionEntry "glGetProgramLocalParameterdv" [t| GLenum -> GLuint -> Ptr GLdouble -> IO () |]
extensionEntry "glGetProgramLocalParameterfv" [t| GLenum -> GLuint -> Ptr GLfloat -> IO () |]
extensionEntry "glGetProgramString" [t| forall a . GLenum -> GLenum -> Ptr a -> IO () |]
