...
import Graphics.Rendering.OpenGL.Raw.Helper.Handle

extensionNameString :: String
extensionNameString = "GL_ARB_shader_objects"

extensionEntry "glDeleteObject" [t| GLhandle -> IO () |]
extensionEntry "glGetHandle" [t| GLenum -> IO GLhandle |]
extensionEntry "glDetachObject" [t| GLhandle -> GLhandle -> IO () |]
extensionEntry "glCreateShaderObject" [t| GLenum -> IO GLhandle |]
extensionEntry "glCreateProgramObject" [t| IO GLhandle |]
extensionEntry "glAttachObject" [t| GLhandle -> GLhandle -> IO () |]
extensionEntry "glUseProgramObject" [t| GLhandle -> IO () |]
extensionEntry "glGetObjectParameterfv" [t| GLhandle -> GLenum -> Ptr GLfloat -> IO () |]
extensionEntry "glGetObjectParameteriv" [t| GLhandle -> GLenum -> Ptr GLint -> IO () |]
extensionEntry "glGetInfoLog" [t| GLhandle -> GLsizei -> Ptr GLsizei -> Ptr GLchar -> IO () |]
extensionEntry "glGetAttachedObjects" [t| GLhandle -> GLsizei -> Ptr GLsizei -> Ptr GLhandle -> IO () |]
