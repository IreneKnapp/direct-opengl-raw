...
extensionEntry "glGetUniformIndices" [t| GLuint -> GLsizei -> Ptr (Ptr GLchar) -> Ptr GLuint -> IO () |]
extensionEntry "glGetActiveUniformsiv" [t| GLuint -> GLsizei -> Ptr GLuint -> GLenum -> Ptr GLint -> IO () |]
extensionEntry "glGetActiveUniformName" [t| GLuint -> GLuint -> GLsizei -> Ptr GLsizei -> Ptr GLchar -> IO () |]
extensionEntry "glGetUniformBlockIndex" [t| GLuint -> Ptr GLchar -> IO GLuint |]
extensionEntry "glGetActiveUniformBlockiv" [t| GLuint -> GLuint -> GLenum -> Ptr GLint -> IO () |]
extensionEntry "glGetActiveUniformBlockName" [t| GLuint -> GLuint -> GLsizei -> Ptr GLsizei -> Ptr GLchar -> IO () |]
extensionEntry "glBindBufferRange" [t| GLenum -> GLuint -> GLuint -> GLintptr -> GLsizeiptr -> IO () |]
extensionEntry "glBindBufferBase" [t| GLenum -> GLuint -> GLuint -> IO () |]
extensionEntry "glGetIntegeri_v" [t| GLenum -> GLuint -> Ptr GLint -> IO () |]
extensionEntry "glUniformBlockBinding" [t| GLuint -> GLuint -> GLuint -> IO () |]
