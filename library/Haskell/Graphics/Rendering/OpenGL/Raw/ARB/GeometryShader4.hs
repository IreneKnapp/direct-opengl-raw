...
extensionEntry "glProgramParameteri" [t| GLuint -> GLenum -> GLint -> IO () |]
extensionEntry "glFramebufferTexture" [t| GLenum -> GLenum -> GLuint -> GLint -> IO () |]
extensionEntry "glFramebufferTextureFace" [t| GLenum -> GLenum -> GLuint -> GLint -> GLenum -> IO () |]
