...
extensionEntry "glWeightbv" [t| GLint -> Ptr GLbyte -> IO () |]
extensionEntry "glWeightsv" [t| GLint -> Ptr GLshort -> IO () |]
extensionEntry "glWeightiv" [t| GLint -> Ptr GLint -> IO () |]
extensionEntry "glWeightfv" [t| GLint -> Ptr GLfloat -> IO () |]
extensionEntry "glWeightdv" [t| GLint -> Ptr GLdouble -> IO () |]
extensionEntry "glWeightubv" [t| GLint -> Ptr GLubyte -> IO () |]
extensionEntry "glWeightusv" [t| GLint -> Ptr GLushort -> IO () |]
extensionEntry "glWeightuiv" [t| GLint -> Ptr GLuint -> IO () |]
extensionEntry "glWeightPointer" [t| forall a . GLint -> GLenum -> GLsizei -> Ptr a -> IO () |]
extensionEntry "glVertexBlend" [t| GLint -> IO () |]
