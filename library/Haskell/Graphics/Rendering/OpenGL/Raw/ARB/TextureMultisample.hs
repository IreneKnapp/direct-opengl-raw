...
extensionEntry "glTexImage2DMultisample" [t| GLenum -> GLsizei -> GLint -> GLsizei -> GLsizei -> GLboolean -> IO () |]
extensionEntry "glTexImage3DMultisample" [t| GLenum -> GLsizei -> GLint -> GLsizei -> GLsizei -> GLsizei -> GLboolean -> IO () |]
extensionEntry "glGetMultisamplefv" [t| GLenum -> GLuint -> Ptr GLfloat -> IO () |]
extensionEntry "glSampleMaski" [t| GLuint -> GLbitfield -> IO () |]
