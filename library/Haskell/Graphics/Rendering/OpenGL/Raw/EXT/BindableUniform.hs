...
extensionEntry "glUniformBuffer" [t| GLuint -> GLint -> GLuint -> IO () |]
extensionEntry "glGetUniformBufferSize" [t| GLuint -> GLint -> IO GLint |]
extensionEntry "glGetUniformOffset" [t| GLuint -> GLint -> IO GLintptr |]
