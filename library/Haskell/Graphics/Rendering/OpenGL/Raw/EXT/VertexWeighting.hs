...
extensionEntry "glVertexWeightf" [t| GLfloat -> IO () |]
extensionEntry "glVertexWeightfv" [t| Ptr GLfloat -> IO () |]
extensionEntry "glVertexWeightPointer" [t| forall a . GLint -> GLenum -> GLsizei -> Ptr a -> IO () |]
